...
export class CustomDashboardNavCtrl {
  ...
  saveDashboard() {
    return this.dashboardSrv.saveDashboard({ noChangeUrl: true });
  }
...
export function customDashNavDirective() {
  return {
    restrict: 'E',
    templateUrl: 'public/app/features/custom-dashboard-loader/custom-dashboard-nav/customDashNav.html',
    controller: CustomDashboardNavCtrl,
...
angular.module('grafana.directives').directive('customDashNav', customDashNavDirective);
