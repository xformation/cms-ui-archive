    ...
    TeamGroupSync.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            React.createElement("div", { className: "page-action-bar" },
                ...
                React.createElement(Tooltip, { className: "page-sub-heading-icon", placement: "auto", content: headerTooltip },
                ...
                groups.length > 0 && (React.createElement("button", { className: "btn btn-success pull-right", onClick: this.onToggleAdding },
            ...
            React.createElement(SlideDown, { in: isAdding },
                React.createElement("div", { className: "cta-form" },
                    ...
                    React.createElement("form", { className: "gf-form-inline", onSubmit: this.onAddGroup },
                        ...
                        React.createElement("div", { className: "gf-form" },
                            React.createElement("button", { className: "btn btn-success gf-form-btn", type: "submit", disabled: !this.isNewGroupValid() }, "Add group"))))),
            groups.length === 0 &&
                !isAdding && (React.createElement("div", { className: "empty-list-cta" },
                React.createElement("div", { className: "empty-list-cta__title" }, "There are no external groups to sync with"),
                React.createElement("button", { onClick: this.onToggleAdding, className: "empty-list-cta__button btn btn-xlarge btn-success" },
