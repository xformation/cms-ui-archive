            ...
            return (React.createElement("tr", { key: user.userId + "-" + index },
                ...
                React.createElement("td", null,
                    React.createElement("div", { className: "gf-form-select-wrapper width-12" },
                        React.createElement("select", { value: user.role, className: "gf-form-input", onChange: function (event) { return onRoleChange(event.target.value, user); } }, ['Teacher', 'Student', 'Admin'].map(function (option, index) {
