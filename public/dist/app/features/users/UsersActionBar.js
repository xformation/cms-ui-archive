        ...
        return (React.createElement("div", { className: "page-action-bar" },
            React.createElement("div", { className: "gf-form gf-form--grow" },
                React.createElement("label", { className: "gf-form--has-input-icon" },
                    React.createElement("input", { type: "text", className: "gf-form-input width-20", value: searchQuery, onChange: function (event) { return setUsersSearchQuery(event.target.value); }, placeholder: "Filter by name or type" }),
                ...
                canInvite && (React.createElement("a", { className: "btn btn-success", href: "org/users/invite" },
                    React.createElement("span", null, "Invite"))),
                externalUserMngLinkUrl && (React.createElement("a", { className: "btn btn-success", href: externalUserMngLinkUrl, target: "_blank" },
