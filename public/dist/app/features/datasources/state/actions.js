...
(function (ActionTypes) {
    ActionTypes["LoadDataSources"] = "LOAD_DATA_SOURCES";
    ActionTypes["LoadDataSourceTypes"] = "LOAD_DATA_SOURCE_TYPES";
    ActionTypes["LoadDataSource"] = "LOAD_DATA_SOURCE";
    ActionTypes["LoadDataSourceMeta"] = "LOAD_DATA_SOURCE_META";
    ActionTypes["SetDataSourcesSearchQuery"] = "SET_DATA_SOURCES_SEARCH_QUERY";
    ActionTypes["SetDataSourcesLayoutMode"] = "SET_DATA_SOURCES_LAYOUT_MODE";
    ActionTypes["SetDataSourceTypeSearchQuery"] = "SET_DATA_SOURCE_TYPE_SEARCH_QUERY";
    ActionTypes["SetDataSourceName"] = "SET_DATA_SOURCE_NAME";
    ActionTypes["SetIsDefault"] = "SET_IS_DEFAULT";
})(ActionTypes || (ActionTypes = {}));
var dataSourcesLoaded = function (dataSources) { return ({
    type: ActionTypes.LoadDataSources,
    payload: dataSources,
}); };
var dataSourceLoaded = function (dataSource) { return ({
    type: ActionTypes.LoadDataSource,
    payload: dataSource,
}); };
var dataSourceMetaLoaded = function (dataSourceMeta) { return ({
    type: ActionTypes.LoadDataSourceMeta,
    payload: dataSourceMeta,
}); };
var dataSourceTypesLoaded = function (dataSourceTypes) { return ({
    type: ActionTypes.LoadDataSourceTypes,
    payload: dataSourceTypes,
}); };
export var setDataSourcesSearchQuery = function (searchQuery) { return ({
    type: ActionTypes.SetDataSourcesSearchQuery,
    payload: searchQuery,
}); };
export var setDataSourcesLayoutMode = function (layoutMode) { return ({
    type: ActionTypes.SetDataSourcesLayoutMode,
    payload: layoutMode,
}); };
export var setDataSourceTypeSearchQuery = function (query) { return ({
    type: ActionTypes.SetDataSourceTypeSearchQuery,
    payload: query,
}); };
export var setDataSourceName = function (name) { return ({
    type: ActionTypes.SetDataSourceName,
    payload: name,
}); };
export var setIsDefault = function (state) { return ({
...
export function loadDataSourceTypes() {
    ...
    return function (dispatch) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getBackendSrv().get('/api/plugins', { enabled: 1, type: 'datasource' })];
                case 1:
                    result = _a.sent();
