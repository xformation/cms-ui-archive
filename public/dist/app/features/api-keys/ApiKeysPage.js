...
var ApiKeysPage = /** @class */ (function (_super) {
    ...
    function ApiKeysPage(props) {
        ...
        _this.onSearchQueryChange = function (evt) {
            _this.props.setSearchQuery(evt.target.value);
        };
            ...
            React.createElement("div", { className: "cta-form" },
                ...
                React.createElement("form", { className: "gf-form-group", onSubmit: this.onAddApiKey },
                    React.createElement("div", { className: "gf-form-inline" },
                        ...
                        React.createElement("div", { className: "gf-form" },
                            React.createElement("button", { className: "btn gf-form-btn btn-success" }, "Add")))))));
    };
            ...
            React.createElement("div", { className: "page-action-bar" },
                React.createElement("div", { className: "gf-form gf-form--grow" },
                    React.createElement("label", { className: "gf-form--has-input-icon gf-form--grow" },
                        React.createElement("input", { type: "text", className: "gf-form-input", placeholder: "Search keys", value: searchQuery, onChange: this.onSearchQueryChange }),
                ...
                apiKeys.length > 0 ? (React.createElement("tbody", null, apiKeys.map(function (key) {
                    return (React.createElement("tr", { key: key.id },
                        ...
                        React.createElement("td", null,
                            React.createElement(DeleteButton, { onConfirmDelete: function () { return _this.onDeleteApiKey(key); } }))));
                }))) : null)));
    };
    ApiKeysPage.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            ...
            hasFetched ? (apiKeysCount > 0 ? (this.renderApiKeyList()) : (this.renderEmptyList())) : (React.createElement(PageLoader, { pageName: "Api keys" }))));
    };
    return ApiKeysPage;
}(PureComponent));
export { ApiKeysPage };
