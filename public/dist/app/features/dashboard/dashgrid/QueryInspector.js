...
var QueryInspector = /** @class */ (function (_super) {
    ...
    QueryInspector.prototype.render = function () {
        ...
        var LoadingPlaceholder = this.props.LoadingPlaceholder;
        var isMocking = this.state.isMocking;
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement("div", { className: "pull-right" },
                ...
                React.createElement(CopyToClipboard, { className: "btn btn-transparent btn-p-x-0", text: this.getTextForClipboard, onSuccess: this.onClipboardSuccess },
                    ...
                    " Copy to Clipboard")),
            !isMocking && React.createElement(JSONFormatter, { json: response, open: openNodes, onDidRender: this.setFormattedJson }),
            isMocking && (React.createElement("div", { className: "query-troubleshooter__body" },
                React.createElement("div", { className: "gf-form p-l-1 gf-form--v-stretch" },
                    React.createElement("textarea", { className: "gf-form-input", style: { width: '95%' }, rows: 10, onInput: this.setMockedResponse, placeholder: "JSON" }))))));
    };
