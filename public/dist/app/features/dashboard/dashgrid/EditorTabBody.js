...
var EditorTabBody = /** @class */ (function (_super) {
    ...
    EditorTabBody.prototype.renderOpenView = function (view) {
        return (React.createElement(PanelOptionSection, { title: view.title || view.heading, onClose: this.onCloseOpenView }, view.render()));
    };
    EditorTabBody.prototype.render = function () {
        var _this = this;
        var _a = this.props, children = _a.children, renderToolbar = _a.renderToolbar, heading = _a.heading, toolbarItems = _a.toolbarItems;
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement("div", { className: "toolbar" },
                ...
                toolbarItems.length > 0 && (React.createElement(React.Fragment, null,
                    React.createElement("div", { className: "gf-form--grow" }),
                    toolbarItems.map(function (item) { return _this.renderButton(item); })))),
            React.createElement("div", { className: "panel-editor__scroll" },
                React.createElement(CustomScrollbar, { autoHide: false },
