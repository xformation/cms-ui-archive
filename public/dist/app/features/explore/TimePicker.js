...
var TimePicker = /** @class */ (function (_super) {
    ...
    TimePicker.prototype.renderDropdown = function () {
        ...
        return (React.createElement("div", { ref: this.dropdownRef, className: "gf-timepicker-dropdown" },
            React.createElement("div", { className: "gf-timepicker-absolute-section" },
                React.createElement("h3", { className: "section-heading" }, "Custom range"),
            ...
            React.createElement("div", { className: "gf-timepicker-relative-section" },
                React.createElement("h3", { className: "section-heading" }, "Quick ranges"),
