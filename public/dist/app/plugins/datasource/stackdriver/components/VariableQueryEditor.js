...
var StackdriverVariableQueryEditor = /** @class */ (function (_super) {
    ...
    StackdriverVariableQueryEditor.prototype.handleQueryTypeChange = function (event) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var state, _a;
    ...
    StackdriverVariableQueryEditor.prototype.insertTemplateVariables = function (options) {
        ...
        return templateVariables.concat(options);
    };
    ...
    StackdriverVariableQueryEditor.prototype.render = function () {
        var _this = this;
        return (React.createElement(React.Fragment, null,
            React.createElement(SimpleSelect, { value: this.state.selectedQueryType, options: this.queryTypes, onValueChange: function (e) { return _this.handleQueryTypeChange(e); }, label: "Query Type" }),
