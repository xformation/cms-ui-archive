                ...
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, ctrl.getGroupBys()];
                        case 1:
                            result = _a.sent();
                            return [2 /*return*/];
                    }
...
function createCtrlWithFakes(existingFilters) {
    ...
    return new StackdriverFilterCtrl(scope, fakeSegmentServer, new TemplateSrvStub(), { $broadcast: function (param) { } });
}
function createTarget(existingFilters) {
    return {
        project: {
            id: '',
            name: '',
