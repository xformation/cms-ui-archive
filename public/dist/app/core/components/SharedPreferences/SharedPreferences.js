...
var SharedPreferences = /** @class */ (function (_super) {
                ...
                switch (_a.label) {
                    ...
                    case 4:
                        this.setState({
                            ...
                            dashboards: [{ id: 0, title: 'Default', tags: [], type: '', uid: '', uri: '', url: '' }].concat(dashboards),
                        });
                        return [2 /*return*/];
                }
            });
    ...
    SharedPreferences.prototype.render = function () {
        ...
        return (React.createElement("form", { className: "section gf-form-group", onSubmit: this.onSubmitForm },
            ...
            React.createElement("div", { className: "gf-form" },
                React.createElement(Label, { width: 11, tooltip: "Not finding dashboard you want? Star it first, then it should appear in this select box." }, "Home Dashboard"),
