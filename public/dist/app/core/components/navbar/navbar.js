...
var NavbarCtrl = /** @class */ (function () {
    /** @ngInject */
    function NavbarCtrl($rootScope, contextSrv, $timeout) {
        this.$rootScope = $rootScope;
        this.contextSrv = contextSrv;
        this.$timeout = $timeout;
    }
    NavbarCtrl.prototype.toggleSideMenu = function () {
        var _this = this;
    ...
    NavbarCtrl.prototype.toggleSideMenuSmallBreakpoint = function () {
