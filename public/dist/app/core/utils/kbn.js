...
kbn.toDuration = function (size, decimals, timeScale) {
    ...
    size *=
        kbn.intervals_in_seconds[units.find(function (e) {
...
kbn.toClock = function (size, decimals) {
    if (size === null) {
        return '';
    }
    // < 1 second
...
kbn.valueFormats.clockms = function (size, decimals) {
    return kbn.toClock(size, decimals);
};
kbn.valueFormats.clocks = function (size, decimals) {
