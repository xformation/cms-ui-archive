...
describe('date time formats', function () {
    var epoch = 1505634997920;
    var utcTime = moment.utc(epoch);
    var browserTime = moment(epoch);
...
describe('clock', function () {
    it('null', function () {
        var str = kbn.toClock(null, 0);
        expect(str).toBe('');
    });
    it('size less than 1 second', function () {
        var str = kbn.toClock(999, 0);
        expect(str).toBe('999ms');
    });
    describe('size less than 1 minute', function () {
        it('default', function () {
            var str = kbn.toClock(59999);
            expect(str).toBe('59s:999ms');
        });
        it('decimals equals 0', function () {
            var str = kbn.toClock(59999, 0);
            expect(str).toBe('59s');
        });
    });
    describe('size less than 1 hour', function () {
        it('default', function () {
            var str = kbn.toClock(3599999);
            expect(str).toBe('59m:59s:999ms');
        });
        it('decimals equals 0', function () {
            var str = kbn.toClock(3599999, 0);
            expect(str).toBe('59m');
        });
        it('decimals equals 1', function () {
            var str = kbn.toClock(3599999, 1);
            expect(str).toBe('59m:59s');
        });
    });
    describe('size greater than or equal 1 hour', function () {
        it('default', function () {
            var str = kbn.toClock(7199999);
            expect(str).toBe('01h:59m:59s:999ms');
        });
        it('decimals equals 0', function () {
            var str = kbn.toClock(7199999, 0);
            expect(str).toBe('01h');
        });
        it('decimals equals 1', function () {
            var str = kbn.toClock(7199999, 1);
            expect(str).toBe('01h:59m');
        });
        it('decimals equals 2', function () {
            var str = kbn.toClock(7199999, 2);
            expect(str).toBe('01h:59m:59s');
        });
    });
    describe('size greater than or equal 1 day', function () {
        it('default', function () {
            var str = kbn.toClock(89999999);
            expect(str).toBe('24h:59m:59s:999ms');
        });
        it('decimals equals 0', function () {
            var str = kbn.toClock(89999999, 0);
            expect(str).toBe('24h');
        });
        it('decimals equals 1', function () {
            var str = kbn.toClock(89999999, 1);
            expect(str).toBe('24h:59m');
        });
        it('decimals equals 2', function () {
            var str = kbn.toClock(89999999, 2);
