...
export function setupAngularRoutes($routeProvider, $locationProvider) {
    ...
    $routeProvider
        ...
        resolve: {
            component: function () { return DataSourcesListPage; },
        },
    })
        .when('/datasources/edit/:id/', {
        template: '<react-container />',
        resolve: {
            component: function () { return DataSourceSettings; },
        },
    })
        .when('/datasources/edit/:id/dashboards', {
        template: '<react-container />',
        resolve: {
            component: function () { return DataSourceDashboards; },
        },
    })
        .when('/datasources/new', {
        template: '<react-container />',
        resolve: {
            component: function () { return NewDataSourcePage; },
        },
    })
        .when('/dashboards', {
        ...
        template: '<react-container />',
        resolve: {
            component: function () { return FolderPermissions; },
        },
    })
        .when('/dashboards/f/:uid/:slug/settings', {
        template: '<react-container />',
        resolve: {
            component: function () { return FolderSettingsPage; },
        },
    })
        ...
        resolve: {
            ...
            component: function () { return import(/* webpackChunkName: "explore" */ 'app/features/explore/Wrapper'); },
        },
    })
        .when('/org', {
        template: '<react-container />',
        resolve: {
            component: function () { return OrgDetailsPage; },
        },
    })
        .when('/org/new', {
        ...
        template: '<react-container />',
        resolve: {
            component: function () { return UsersListPage; },
        },
    })
        ...
        resolve: {
            roles: function () { return ['Editor', 'Admin']; },
            component: function () { return ApiKeys; },
        },
    })
        .when('/org/teams', {
        template: '<react-container />',
        resolve: {
            roles: function () { return ['Editor', 'Admin']; },
            component: function () { return TeamList; },
        },
    })
        .when('/org/teams/new', {
        ...
        resolve: {
            ...
            component: function () { return TeamPages; },
        },
    })
        .when('/profile', {
        ...
        template: '<react-container />',
        resolve: {
            component: function () { return ServerStats; },
        },
    })
        // LOGIN / SIGNUP
        .when('/login', {
        ...
        template: '<react-container />',
        resolve: {
            component: function () { return PluginListPage; },
        },
    })
        ...
        reloadOnSearch: false,
        resolve: {
            component: function () { return AlertRuleList; },
        },
    })
