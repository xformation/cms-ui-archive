...
import { setTimeSrv } from 'app/features/dashboard/time_srv';
...
var GrafanaCtrl = /** @class */ (function () {
    /** @ngInject */
    function GrafanaCtrl($scope, utilSrv, $rootScope, $controller, contextSrv, bridgeSrv, backendSrv, timeSrv, datasourceSrv, angularLoader) {
...
export { GrafanaCtrl };
function setViewModeBodyClass(body, mode, sidemenuOpen) {
...
export function grafanaAppDirective(playlistSrv, contextSrv, $timeout, $rootScope, $location) {
    return {
        ...
        link: function (scope, elem) {
            ...
            body.toggleClass('sidemenu-open', sidemenuOpen);
            appEvents.on('toggle-sidemenu', function () {
                sidemenuOpen = scope.contextSrv.sidemenu;
            ...
            scope.$watch(function () { return playlistSrv.isPlaying; }, function (newValue) {
            ...
            scope.$on('$routeChangeSuccess', function (evt, data) {
                ...
                // close all drops
                for (var _i = 0, _a = Drop.drops; _i < _a.length; _i++) {
                    var drop = _a[_i];
                    drop.destroy();
                }
            });
